...
import browserSupport from './browser-support.png';
...
magic of container queries. When using “container-type: size” then the queries can check both width and
height of the element. This also means that we have to specify both width and height of the container.

In my experience “container-type: inline-size” is the most useful one. For one thing you only need
...
has great browser support today! So go out and give it a go 🚀.
