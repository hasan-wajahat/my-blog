  ...
  return (
    <section className="relative flex flex-col">
      <div className="flex">
        ...
        <div className="flex flex-shrink flex-grow basis-0 justify-center rounded-md bg-gradient-to-r from-transparent dark:to-[#03a8f430]">
          <Image src={profileImg} alt="Hasan" priority className="w-[420px]" />
        </div>
      </div>

      <div className="relative bottom-10 mx-auto flex max-w-[80%] rounded-lg bg-gray-200 px-5 py-3 shadow-[0_0_2px_2px] shadow-gray-500/20 dark:bg-gray-900">
